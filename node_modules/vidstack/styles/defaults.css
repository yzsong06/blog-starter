...
:where(media-player:not([controls]) media-outlet) {
  pointer-events: auto;
...
:where(media-player:not([controls]) media-outlet video) {
  pointer-events: none;
}
...
:where(media-chapters-menu-items) {
  ...
  min-width: var(--media-chapters-min-width, var(--media-menu-min-width, 180px));
}
