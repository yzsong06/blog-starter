import { VideoProvider } from './chunk-DPZK4RA4.js';
import { RAFLoop, LIST_SELECT, LIST_ADD } from './chunk-M4MYZEWS.js';
import { isHLSSupported, IS_CHROME } from './chunk-M727CDUQ.js';
import { TextTrack, TEXT_TRACK_READY_STATE, TEXT_TRACK_ON_MODE_CHANGE } from './chunk-ZG64VF3W.js';
import { preconnect, loadScript } from './chunk-72VYJ2OF.js';
...
var HLSController = class {
  ...
  _liveSyncPosition() {
    var _a2;
    this._context.$store.liveSyncPosition.set(((_a2 = this._instance) == null ? void 0 : _a2.liveSyncPosition) ?? Infinity);
  }
  ...
  _destroy() {
    ...
    (_a2 = this._instance) == null ? void 0 : _a2.destroy();
    this._instance = null;
...
var HLSProvider = class extends VideoProvider {
  ...
  async loadSource({ src }) {
    ...
    if (!isString(src))
      return;
    (_a2 = this._controller.instance) == null ? void 0 : _a2.loadSource(src);
  }
  /**
