import { sliderProps, Slider } from './chunk-WCL5EF2A.js';
...
import { $$_ssr, $$_classes, $$_styles } from 'maverick.js/ssr';
...
var $$_templ = ['<!$><div part="chapters"', "><!$>", "</div>"];
var $$_templ_2 = [""];
var $$_templ_3 = ['<!$><div part="chapter-container"', '><div part="chapter"><div part="track"></div><!$><div part="track track-fill"', '></div><div part="track track-progress"></div></div></div>'];
var SliderChaptersRenderer = class {
  ...
  render(cues, $class) {
    return $$_ssr(
      $$_templ_2,
      (cues == null ? void 0 : cues.length) ? $$_ssr($$_templ, $$_classes($class), this._renderChapters(cues)) : null
    );
  }
  ...
  _renderChapter(chapter, endTime) {
    ...
    return $$_ssr($$_templ_3, $$_styles("", { "width": width }), $$_styles("", { "width": $fill }));
  }
...
var TimeSlider = class extends Slider {
  ...
  _hasChapters() {
    ...
    (_a = this._classManager) == null ? void 0 : _a._requestUpdate();
    return ((_b = this._track()) == null ? void 0 : _b.cues.length) && Number.isFinite(duration()) && duration() > 0;
  }
  onConnect(el) {
    super.onConnect(el);
  ...
  render() {
    ...
    return [$$_ssr($$_templ2, this._chaptersRenderer.render((_a = this._track()) == null ? void 0 : _a.cues, chaptersClass)), $$_ssr($$_templ_22, tracks)];
  }
  ...
  _onTrackChange() {
    var _a;
    this._track();
    this._chapterTitleEl = ((_a = this.el) == null ? void 0 : _a.querySelector('[part="chapter-title"]')) ?? null;
