...
import { signal, onDispose, peek, computed, tick, effect } from 'maverick.js';
...
var AudioProviderLoader = class {
  ...
  async load() {
    return new (await import('./provider-JTVX457Q.js')).AudioProvider(this._audio);
  }
  render($store) {
    {
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    return new (await import('./provider-267RSV7C.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await import('./provider-DZVCBT6D.js')).HLSProvider(this._video, context);
  }
};
