import { SET_AUTO_QUALITY, ENABLE_AUTO_QUALITY, coerceToError } from './chunks/chunk-X3VNDHOX.js';
import { TEXT_TRACK_CROSSORIGIN, isTrackCaptionKind, findActiveCue, isCueActive, onTrackChapterChange, preconnect, TEXT_TRACK_CAN_LOAD, TEXT_TRACK_UPDATE_ACTIVE_CUES, getRequestCredentials, ATTACH_VIDEO, TEXT_TRACK_NATIVE_HLS, TextTrack, TEXT_TRACK_ON_MODE_CHANGE, TEXT_TRACK_NATIVE } from './chunks/chunk-RYZAAEAH.js';
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import('./chunks/provider-6E4GJROU.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./chunks/provider-2GTBFQFG.js')).HLSProvider(this._video, context);
  }
};
...
var MediaStoreSync = class extends ComponentController {
  onAttach(el) {
    ...
    effect2(this._onTitleChange.bind(this));
  }
  _onLogLevelChange() {
...
var ThumbnailsLoader = class extends ComponentController {
  ...
  _onLoadCues() {
    ...
    if (!src)
      return;
    import('./chunks/dev-GQQUQYRY.js').then(({ parseResponse }) => {
      parseResponse(
        fetch(src, {
...
var Player = class extends Component {
  ...
  _watchTitle() {
    const { title, live, viewType } = this.$store, isLive = live(), type = uppercaseFirstChar(viewType()), typeText = type !== "Unknown" ? `${isLive ? "Live " : ""}${type}` : isLive ? "Live" : "Media";
    setAttribute(
      this.el,
      "aria-label",
  ...
  _onResize() {
    if (!this.el)
      return;
    const width = this.el.clientWidth, height = this.el.clientHeight, bpx = width < 600 ? "sm" : width < 980 ? "md" : "lg", bpy = height < 380 ? "sm" : height < 600 ? "md" : "lg";
...
function DesktopUI2() {
  return (() => {
    const $$_root = $$_clone($$_templ_25), $$_el = $$_root.firstChild, $$_el_2 = $$_el.nextSibling, $$_el_3 = $$_el_2.nextSibling, $$_el_4 = $$_el_3.nextSibling, $$_el_5 = $$_el_4.firstChild; $$_el_5.firstChild; const $$_el_7 = $$_el_5.nextSibling, $$_el_8 = $$_el_7.nextSibling, $$_el_9 = $$_el_8.firstChild, $$_el_10 = $$_el_9.nextSibling, $$_el_11 = $$_el_8.nextSibling;
    $$_insert_lite($$_root, $$_create_component(VideoGestures), $$_el);
    $$_setup_custom_element($$_el);
    $$_setup_custom_element($$_el_2);
    $$_insert_lite($$_el_5, $$_create_component(ChaptersMenu), null);
    ...
    $$_insert_lite($$_el_8, $$_create_component(TimeSlider), $$_el_10);
    $$_setup_custom_element($$_el_10);
    $$_insert_lite($$_el_11, $$_create_component(PlayButton), null);
    $$_insert_lite($$_el_11, $$_create_component(MuteButton), null);
    $$_insert_lite($$_el_11, $$_create_component(VolumeSlider), null);
    $$_insert_lite($$_el_11, $$_create_component(MainTitle), null);
    $$_insert_lite($$_el_11, $$_create_component(CaptionButton), null);
    $$_insert_lite($$_el_11, $$_create_component(PiPButton), null);
    $$_insert_lite($$_el_11, $$_create_component(FullscreenButton), null);
    return $$_root;
  })();
}
...
var Gesture = class extends Component {
  ...
  _acceptEvent(event) {
    if (!this._inBounds(event) || isPointerEvent(event) && event.button !== 0)
      return;
...
var MenuFocusController = class {
  ...
  _getFocusableElements() {
    ...
    for (const el of focusableElements) {
      if (isElementParent(this._el, el, is))
        elements.push(el);
    }
    return elements;
  }
...
var $$_templ_212 = /* @__PURE__ */ $$_create_template(`<div part="chapter-container"><div part="chapter"><div part="track"></div><div part="track track-fill"></div><div part="track track-progress"></div></div></div>`);
var SliderChaptersRenderer = class {
  constructor(_media, _slider, _onChange) {
    ...
    this._updateBufferedPercent = animationFrameThrottle((bufferedPercent) => {
      for (let i = 0; i < this._refs.length; i++) {
        const el = this._refs[i].querySelector('[part~="track-progress"]'), percent = this._calcChapterPercent(this._chapters[i], bufferedPercent);
  ...
  _renderChapters(cues) {
    ...
    for (const chapter of this._chapters) {
      const el = this._renderChapter(chapter, endTime);
      this._refs.push(el);
    }
  ...
  _renderChapter(chapter, endTime) {
    const width = round(this._calcWidth(chapter, endTime), 5) + "%", $fill = this._calcFillPercent.bind(this, chapter);
    return (() => {
      const $$_root = $$_clone($$_templ_212), $$_el = $$_root.firstChild, $$_el_2 = $$_el.firstChild, $$_el_3 = $$_el_2.nextSibling;
      $$_style($$_root, "width", width);
      $$_effect(() => $$_style($$_el_3, "width", $fill()));
      return $$_root;
    })();
  }
  _calcFillPercent(chapter) {
    let fillPercent = this._slider.fillPercent(), pointing = this._slider.pointing(), pointerPercent = pointing ? this._slider.pointerPercent() : fillPercent, percent = this._calcChapterPercent(chapter, fillPercent), result = percent + "%";
    if (pointing) {
