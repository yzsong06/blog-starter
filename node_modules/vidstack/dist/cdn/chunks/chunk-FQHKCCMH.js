import { ParseError, ParseErrorCode } from './chunk-7HP72ZKK.js';
import { parseVTTTimestamp } from './chunk-N6ND4DEI.js';

// ../../node_modules/.pnpm/media-captions@0.0.13/node_modules/media-captions/dist/dev.js
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import('./parse-EAJAJASE-INJR4P4X.js')).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import('./parse-AJOCGGZB-OHZRWE2F.js')).default;
        break;
      default:
        factory = (await import('./parse-OR37CYZA-X62NIUPB.js')).default;
    }
  } else {
    factory = type;
  }
