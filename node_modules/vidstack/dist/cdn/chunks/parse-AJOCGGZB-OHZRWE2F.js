import { VTTCue, parseVTTTimestamp } from './chunk-N6ND4DEI.js';
import './chunk-VPSTUDLO.js';

// ../../node_modules/.pnpm/media-captions@0.0.13/node_modules/media-captions/dist/chunks/parse-AJOCGGZB.js
...
var SSAParser = class {
  ...
  async init(init) {
    this._init = init;
    if (init.errors)
      this._errorBuilder = (await import('./errors-VSYRGBIT-BYETTSHV.js')).ParseErrorBuilder;
  }
