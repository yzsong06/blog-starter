import { VideoProvider, preconnect, TextTrack, TEXT_TRACK_READY_STATE, TEXT_TRACK_ON_MODE_CHANGE, loadScript } from './chunk-RYZAAEAH.js';
import { isHLSSupported, RAFLoop, LIST_SELECT, LIST_ADD, IS_CHROME } from './chunk-XBYQR33W.js';
import { isString, peek, DOMEvent, listenEvent, effect2, isUndefined, isFunction2, camelToKebabCase } from './chunk-BFUJ5USN.js';
...
var HLSController = class {
  ...
  setup(ctor, context) {
    ...
    this._stopLiveSync = effect2(this._liveSync.bind(this));
  }
  _liveSync() {
