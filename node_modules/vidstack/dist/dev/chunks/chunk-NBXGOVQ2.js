...
var AudioProviderLoader = class {
  ...
  async load() {
    ...
    return new (await import('./provider-757XAECH.js')).AudioProvider(this._audio);
  }
  render($store) {
    return (() => {
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import('./provider-OS7BDV2A.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./provider-XMMP3QRV.js')).HLSProvider(this._video, context);
  }
};
