...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./chunks/parse-EAJAJASE.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./chunks/parse-AJOCGGZB.js")).default;
        break;
      default:
        factory = (await import("./chunks/parse-OR37CYZA.js")).default;
    }
  } else {
    factory = type;
  }
