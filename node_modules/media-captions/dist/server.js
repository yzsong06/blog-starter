...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./chunks/parse-XNBCGRPN.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./chunks/parse-EMUA5CBZ.js")).default;
        break;
      default:
        factory = (await import("./chunks/parse-UTMWXINU.js")).default;
    }
  } else {
    factory = type;
  }
